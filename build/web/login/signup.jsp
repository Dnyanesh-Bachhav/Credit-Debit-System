<%-- 
    Document   : signup
    Created on : Aug 19, 2022, 3:57:49 PM
    Author     : Dell
--%>
          ...
          <div class="card-body">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" action="../controller/signupController.jsp" method="POST" >
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                        <input type="number" name="balance" id="form3Example4cd" class="form-control" required="" />
